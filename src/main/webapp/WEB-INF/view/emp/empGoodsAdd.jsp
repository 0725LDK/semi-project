...
<head>
<meta charset="UTF-8">
<title>934마켓 상품 등록 | 전통주의 모든것, 934마켓</title>
	...
	<script>
		$(document).ready(function() {
			...
			//상품 추가시 유효성 검사
			$('#goodsAddFormBtn').click(function()
					{
						if($('#categoryName').val() == '')
						{
							alert('주종을 입력하세요');
						...
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">이벤트 추가</h4>
									<form class="forms-sample" action="${pageContext.request.contextPath}/emp/empGoodsAdd" method="post" enctype="multipart/form-data" id="goodsAddForm">
										<table class="table table-striped table-borderless" style="width:100%">
											...
											<tr>
												<th>상품 가격 : </th>
												<td>
													<input class="form-control" type="number" name="goodsPrice" id="goodsPrice">
												</td>
											</tr>
											<tr>
												<th>상품 설명 : </th>
												<td>
													<textarea class="form-control" name="goodsContent" rows="10" cols="50" id="goodsContent"></textarea>
												</td>
											</tr>
											<tr>
												<th>상품 도수 : </th>
												<td>
													<input class="form-control" type="number" step="0.1" name="goodsAlcohol" id="goodsAlcohol">
												</td>
											</tr>			
											<tr>
												<th>상품 용량 : </th>
												<td>
													<input class="form-control" type="number" name="goodsLiter" id="goodsLiter">
												</td>
											</tr>			
											<tr>
												<th>상품 재고 : </th>
										...
										<div align="center">
											<button type="button" id="goodsAddFormBtn" class="btn btn-primary mr-2">상품등록</button>
