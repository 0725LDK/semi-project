	...
	<main class="form-signin">
	  <form method="post" action="${pageContext.request.contextPath}/home/login">
	    ...
	    <div class="form-floating">
	      <input type="text" class="form-control" id="floatingInput" name="loginId" placeholder="아이디" value="admin">
	    </div>
	    <div class="form-floating">
	    ...
	    <button class="w-100 btn btn-lg btn btn-primary" type="submit">직원 로그인</button>
	  </form>
	  <br>
		...
		<a href="${pageContext.request.contextPath}/home/login">회원로그인</a>		
	</main>
</body>
</html>